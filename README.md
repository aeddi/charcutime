...
Visit the [live version](https://aeddi.github.io/charcutime).
...
4. Open **Preferences** to sync your data across devices by signing in with your GitHub or Google account
